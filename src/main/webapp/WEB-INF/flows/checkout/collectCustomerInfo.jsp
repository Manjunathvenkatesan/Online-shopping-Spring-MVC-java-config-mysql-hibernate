        ...
        <div class="form-layout">
	       <form:form      method="post" commandName="order"     class="form-horizontal"  >
				...
				<div class="form-group has-success">
                 ...
                 <form:input path="cart.customer.custometPhoneNumber" id="custometPhoneNumber" class="form-control" disabled="true"/>
					</div>
				</div>
				...
				<div class="form-group has-success">
                 ...
                 <form:input path="cart.customer.billingAddress.strretName" id="billingAddress.strretName" class="form-control" disabled="true"/>
					</div>
				</div>
